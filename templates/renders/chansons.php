...
<section class="titres">
    ...
    <li>
        ...
        <button class="add-to-playlist-button" onclick="showPlaylistsPopup(<?php echo $index + 1; ?>)">Ajouter à la
            playlist</button>
        <?php else : ?>
        ...
        <div id="popup-playlists<?php echo $index + 1; ?>" class="popup-playlists" style="display: none;">
            <div class="popup-content">
                <span class="close-popup-playlists" onclick="closePlaylistsPopup(<?php echo $index + 1; ?>)">&times;</span>
                <h3>Ajouter à la playlist du titre :
                    <?php echo $chanson->getTitre() ?>
                </h3>

                <form action="../../app/Model/ajout_chanson_playlist.php" method="post">
                    <input type="hidden" name="chanson_id" value="<?php echo $index + 1; ?>">
